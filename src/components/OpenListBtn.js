    ...
    return(
        <div>
            <button className="OpenList" onClick={charginglistBtn}>
                ...
                >
                    <rect width="26" height="25" fill="white" fillOpacity="0.67"></rect>
                    <path d="M8.66667 6.25H22.75M8.66667 12.5H22.75M8.66667 18.75H22.75M3.25 6.25H3.26083M3.25 12.5H3.26083M3.25 18.75H3.26083" stroke="#073DFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
            </button>
        </div>
    )
